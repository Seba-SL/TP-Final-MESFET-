...
Cuando la tensión de compuerta se encuentra aproximadamente entre $0,5\,V$ y $1,0 \,V $ por debajo del umbral en un MESFET de canal n, la corriente de drenador alcanza un valor mínimo y luego aumenta lentamente a medida que disminuye la tensión de compuerta.
...
\begin{figure}[H]
	...
	\begin{minipage}[c]{0.55\textwidth}
		 ...
		 La corriente de drenador en esta región se denomina corriente de fuga de compuerta. La Figura \ref{fig:efectos_corr_gate} muestra un gráfico de la corriente de drenador en función de $V_{GS}$ para las tres regiones.
