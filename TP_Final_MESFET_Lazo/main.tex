...
\begin{figure}[H]
	...
	\begin{minipage}[c]{0.5\textwidth}
		...
		Se observa que el ancho de la zona de vaciamiento cumple
		$W_{d0} < W_d(0) < a$, mientras que $W_d(L) = a$.
		A medida que $V_{DS}$ aumenta más allá de $V_{DS_{\text{SAT}}}$,
		la longitud de la región de empobrecimiento crece a lo largo del canal,
		pero el nivel de $I_D$ permanece constante, razón por la cual
		$V_{DS}$ no incide en $I_D$ en esta región.
