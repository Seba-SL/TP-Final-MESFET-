...
\begin{equation}
	I_D =A_{ch}\cdot J_{arr, n} = (Z\cdot [a - W(x)]) \cdot q \cdot n \cdot \mu_n \cdot \xi  =  q \cdot N_D \cdot \mu_n \cdot (- \frac{dV}{dx})
\end{equation}
...
\begin{tcolorbox}[colback=black!5!white, colframe=black!75!black, title=Expresión de la corriente ID completa en función de los parámetros de control y del circuito externo]
		...
		\begin{equation}
				...
				\frac{
					...
					\left( \dfrac{q N_D a^2}{2 \epsilon_s } \right)^{1/2}
				}
				\right\}
		\end{equation}
...
Comunmente se define la conductancia de canal completo $g_o = \frac{Z \, q \, \mu_n \, N_D \, a}{L}  $ y ya conociendo la expresión de tensión $V_p = \frac{q N_D a^2}{2 \epsilon } $, la expresión se puede reescribir como:
