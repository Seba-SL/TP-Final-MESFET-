...
Una vez obtenida la expresión completa (\ref{equation:Expresion_Completa}) se puede comparar con el modelo clásico de Schockley (\ref{equation:modo_estrangulacion}).  

\section{Simulación de curvas}

Utilizando un código adecuado de \textit{Python} detallado en el Apéndice~\ref{sec:apendice_codigo}, se obtienen las curvas características del dispositivo.
